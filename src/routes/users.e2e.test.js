...
describe('User Routes E2E Tests', () => {
    ...
    it('PATCH /api/users/me should return 200 when authenticated user is updated', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                ...user,
    ...
    it('DELETE /api/users/me should return 200 when authenticated user is deleted', async () => {
        const { body: createdUser } = await request(app)
            .post('/api/users')
            .send({
                ...user,
